                    ...
                    <form id="msform">
                            ...
                            <div class="form-card">
                                ...
                                <div class="row">
                                    <div class="col-6 text-center">
                                        <div class="typeCard next" data-id="1">
                                    ...
                                    <div class="col-6 text-center">
                                        <div class="typeCard next" data-id="2">
                                    ...
                                    <input type="hidden" name="vccsType" id="vccsType" value="1">
                                </div>
                                <div class="row">
                                    <div class="col-12 text-center">
                        ...
                        <fieldset class="fourthStep">
                            ...
                            <div class="form-card">
                                ...
                                <input type="hidden" name="schedule" id="schedule" value="14:30" required />
                            </div>
